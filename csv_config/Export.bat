tabtoy.exe --csharp_out=.\DataConfig.cs --binary_out=.\DataConfig.bytes --json_out=.\DataConfig.json --go_out=.\DataConfig.go --combinename=DataConfig --lan=zh_cn Equip.xlsx Item.xlsx
